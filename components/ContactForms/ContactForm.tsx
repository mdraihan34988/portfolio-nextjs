...
} from "../FramerMotion/FramerMotionVariants";
import Ripples from "react-ripples";

// initial State of the form
const initialFormState = {
  to_name: "Md Raihanul Islam",
  first_name: "",
  last_name: "",
  email: "",
  subject: "",
  ...
  return (
    <>
      <motion.form
        ...
        viewport={{ once: true }}
        className="w-full flex flex-col items-center max-w-xl mx-auto my-10 text-black dark:text-gray-300"
        onSubmit={sendEmail}
