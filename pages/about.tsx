    ...
    >
      <div className="flex flex-col justify-center items-start max-w-2xl mx-auto mb-16 w-full pt-4">
        ...
        <div className="mb-8 prose dark:prose-dark px-6">
          ...
          <p>At Line Reflection LTD, I lead full-stack development for production applications across SaaS, eCommerce, CRM, LMS, finance, healthcare, and payment-enabled platforms, and drive AI-augmented DevOps for the CodersTrust JobReady platform (AWS EKS → Vultr Kubernetes migration) using Claude, Codex, and K8sGPT. At Nomadiccare, I work as a Senior Software Engineer on connected healthcare products that help clinicians and care teams manage digital care plans, patient engagement, and mobile-first care workflows, applying AI-augmented development with Claude Code.</p>
          <h3>Core Skillset</h3>
          <p>React.js, Next.js, JavaScript, TypeScript, Node.js, Express.js, Laravel, PHP, Spring Boot, REST API, MySQL, MSSQL, PostgreSQL, Firebase, Redis, Kafka, Docker, AWS, Google Cloud Run, Kubernetes, ArgoCD, Tailwind CSS, Bootstrap, Git, payment gateway integration, healthcare workflow development, SaaS architecture, eCommerce platforms, CRM systems, LMS products, and admin dashboards.</p>
          <h3>AI & Automation Tools</h3>
          <p>Claude Code (AI-augmented development — Nomadiccare), Codex (AI-augmented DevOps — CodersTrust JobReady), Cursor, Minimax, OpenCode, Goose, K8sGPT, Playwright, Maestro — applied across production feature delivery, infrastructure operations, Kubernetes migration, load testing, web E2E testing, and mobile E2E testing.</p>
          {/* <h3>Education</h3>
          <ul>
            <li>
